...
% affiliations
\author{\IEEEauthorblockN{Andrew Heyman}
...
To correctly evaluate the current research landscape, we must obtain literature focusing on: employee sentiment and company performance, detecting sentiment from user-submitted data, and Glassdoor as a data source.


In \cite{luo2016employee} 

In \cite{Moniz2014} obtained 41,227 reviews
...
I have narrowed this down into two sections: equity prices and 


%\begin{figure}[!t]
%\centering
%\includegraphics[width=2.5in]{img/myfigure}
